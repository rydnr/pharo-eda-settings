# nix/shared.nix
#
# This file provides functions used by pharo-eda-settings's Nix flake.
#
# Copyright (C) 2025-today rydnr's pharo-eda-settings
#
...
rec {
  shellHook-for = { nixpkgs-release, org, package, repo, tag }:
    ''
      ...
      echo -e "\033[34m     |                   \033[0m        \033[33m    |\033[0m        \033[35m          |    |    o                 \033[32mhttps://github.com/${org}\033[0m"
